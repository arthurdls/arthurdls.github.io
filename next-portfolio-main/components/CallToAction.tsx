        ...
        <SectionWrapper id='cta' className="xl:max-w-6xl my-24 lg:mx-10 xl:mx-auto mx-4 relative overflow-hidden flex flex-col-reverse md:flex-row gap-3 md:gap-0 items-center bg-gradient-to-r from-blue-700 to-blue-600 text-white rounded-2xl p-6 md:p-8 lg:px-12 lg:py-16 z-10">
            <div className="flex flex-col md:w-1/2 lg:w-3/5">
                ...
                <div className="flex items-center gap-4 my-4">
                    ...
                    <Link href="https://github.com/jigar-sable/next-portfolio#readme" target="_blank" className="py-2 px-4 bg-blue-800 rounded-lg w-fit flex items-center gap-2 hover:bg-blue-900 transition-all">
                        Visit Docs
                        <BiLinkExternal />
                    </Link>
                </div>
